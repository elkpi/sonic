...
var (
    ...
    _subr__skip_array   = __native_entry__() + 17696
    _subr__skip_number  = __native_entry__() + 20635
    _subr__skip_object  = __native_entry__() + 17733
    _subr__skip_one     = __native_entry__() + 15848
    _subr__u64toa       = __native_entry__() + 3748
    _subr__unquote      = __native_entry__() + 6010
    _subr__validate_one = __native_entry__() + 20752
    _subr__value        = __native_entry__() + 10907
    _subr__vnumber      = __native_entry__() + 13862
    _subr__vsigned      = __native_entry__() + 15292
    _subr__vstring      = __native_entry__() + 12815
    _subr__vunsigned    = __native_entry__() + 15572
)
