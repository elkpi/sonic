...
var (
    ...
    _subr__skip_array   = __native_entry__() + 20471
    _subr__skip_number  = __native_entry__() + 23991
    _subr__skip_object  = __native_entry__() + 20508
    _subr__skip_one     = __native_entry__() + 18628
    _subr__u64toa       = __native_entry__() + 4003
    _subr__unquote      = __native_entry__() + 7158
    _subr__validate_one = __native_entry__() + 24108
    _subr__value        = __native_entry__() + 13550
    _subr__vnumber      = __native_entry__() + 16642
    _subr__vsigned      = __native_entry__() + 18072
    _subr__vstring      = __native_entry__() + 15735
